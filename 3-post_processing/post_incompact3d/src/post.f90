...
! Correlations calculation for TTBL
   ...
   call MPI_ALLREDUCE(RuuzH1,RuuzHT,ysize(2)*ysize(3),real_type,MPI_SUM,MPI_COMM_WORLD,code)
   call MPI_ALLREDUCE(RvvzH1,RvvzHT,ysize(2)*ysize(3),real_type,MPI_SUM,MPI_COMM_WORLD,code)
   call MPI_ALLREDUCE(RwwzH1,RwwzHT,ysize(2)*ysize(3),real_type,MPI_SUM,MPI_COMM_WORLD,code)
